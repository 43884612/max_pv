    ...
    try:
     ...
     #-----Fungsi List Group------#   
      ...
      #-------------Fungsi Creator Start-----------------# 
                ...
                if msg.toType == 2:
                    msg.contentType = 13
                    Creatorbot = "ub8fd0c502d6d52c35d8bc6fcced407d0"
                    try:
                        msg.contentMetadata = {'mid': Creatorbot}
                        
                    except:
                        Creatorbot = "Error"
                    cl.sendText(msg.to, "My Creator : IP/nhttp://line.me/ti/p/~bots_line")
                    cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                ki7.sendText(msg.to,"Ok  􀨁􀄻double thumbs up􏿿")
                ki8.sendText(msg.to,"Ok  􀨁􀄻double thumbs up􏿿")
                ki9.sendText(msg.to,"Ok  􀨁􀄻double thumbs up􏿿")
                ki10.sendText(msg.to,"Ok  􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"MAX 1")
                ki2.sendText(msg.to,"MAX 2")
                ki3.sendText(msg.to,"MAX 3")
                ki4.sendText(msg.to,"MAX 4")
                ki5.sendText(msg.to,"MAX 5")
                ki6.sendText(msg.to,"MAX 6")
                ki7.sendText(msg.to,"MAX 7")
                ki8.sendText(msg.to,"MAX 8")
                ki9.sendText(msg.to,"MAX 9")
                ki10.sendText(msg.to,"MAX 10")
#-----------------------------------------------
